 ...
 *
 *  Unless required by sitelicable law or agreed to in writing, software
...
gulp.task('serve', ['scripts', 'styles'], () => {
  browserSync({
    ...
    scrollElementMsiteing: ['main', '.mdl-layout'],
...
gulp.task('copy-sw-scripts', () => {
  return gulp.src(['node_modules/sw-toolbox/sw-toolbox.js', 'site/scripts/sw/runtime-caching.js'])
...
// live reload to work as expected when serving from the 'site' directory.
