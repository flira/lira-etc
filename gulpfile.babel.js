...
/*
 * Editado na Segec / TCU para suporte a typescript e importação de fontes
 */
...
gulp.task('typescript', () =>
  browserify()
    .add(['src/scripts/_vendors.ts', 'src/scripts/main.ts'])
    .plugin(tsify)
    .bundle()
    .on('error', function (error) { console.error(error.toString()); })
    .pipe(source(tsOptions.fileName))
...
gulp.task('styles', () => {
  ...
  // Adicionar pasta com plugins em includePaths.
  return gulp.src([
    'src/styles/*.scss',
    'src/styles/*.css'
  ])
...
// Copia as fontes para a pasta src
gulp.task('fonts', () =>
gulp.src([
  'src/styles/fonts/**/*.eot',
  'src/styles/fonts/**/*.otf',
...
gulp.task('default', ['clean'], cb =>
  runSequence(
    'styles',
    ['typescript:dist', 'html' , 'images', 'fonts','copy'],
...
gulp.task('pagespeed', cb =>
  ...
  pagespeed('fernando.lira.etc.br', {
    strategy: 'mobile'
...
gulp.task('generate-service-worker', ['copy-sw-scripts'], () => {
  ...
  return swPrecache.write(filepath, {
    ...
    cacheId: pkg.name || 'Portal do Tribunal de Contas da União',
